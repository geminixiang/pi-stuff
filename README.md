...
| [`@geminixiang/pi-agent-team`](packages/pi-agent-team)       | 0.1.0                                                                                                                             | Rule-agnostic independent agent sessions with private mailboxes, handoff, claims, and causal audit.  |
